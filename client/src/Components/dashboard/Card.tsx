    ...
    return (
      <div className="relative group flex-mx-2 w-full h-full">
        ...
        <div className={`relative px-4 py-3 bg-dark rounded-md rounded-lg shadow-md ${color}`}>
          <p className={`bg-white w-content h-full rounded-lg ${text} font-bold inline-block px-2`}>{Number(percent)?percent:0}%</p>
          <h5 className="text-center text-white text-gray-900">{name}</h5>
          <h3 className="text-center text-white text-gray-900">{money}$</h3>
        </div>
    </div>
