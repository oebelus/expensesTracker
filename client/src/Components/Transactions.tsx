    ...
    return (
        <div>
            ...
            {data.map((el: Transaction, key: number) => (
                <div key={key} className="flex items-center p-4 space-x-4 rounded-md bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-100">
                    <div className="flex items-center self-stretch justify-center bg-gray-300 dark:bg-gray-700 rounded-full p-2">
                       <FontAwesomeIcon icon={faMoneyBillAlt} className="p-2"/>
                    </div>
                    <div className="flex flex-col">
                        <span className="font-semibold">{el.name}: {el.amount}$</span>
